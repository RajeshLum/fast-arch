...
const ProjectBlog = ({titleMenu}) =>{
	...
	return(
		<>
			...
			<div className="mb-3"><i className="far fa-calendar me-3" aria-hidden="true"></i>Created on June 8th, 2024</div>
			<div className="media align-items-center">
				...
				<div className="media-body">
					...
					<span className="text-black font-w600">Monday,  June 17th 2024</span>
				</div>
			</div>
		</>
	)	
